...
def main(train_df, val_df, model_path, output_dir, id2label, label2id):
    ...
    training_args = TrainingArguments(
        ...
        push_to_hub=False,
        report_to="wandb",
        run_name="ModernBERT-Base-Agent",
    )
...
if __name__ == "__main__":
    ...
    main(train_df, val_df, model_path="answerdotai/ModernBERT-base", output_dir="modernbert-agent-3", id2label=id2label_agent, label2id=label2id_agent)
